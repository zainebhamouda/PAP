...
function FormReglePlate({ auditeurs, plants, onSubmit, loading }) {
    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
        <Select label="Plant" value={plantId} onChange={setPlantId} required
          options={plants} placeholder="Sélectionner le plant…" />
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {step === 'regle-plate' && (
          <FormReglePlate auditeurs={auditeurs} plants={plants} onSubmit={handleSubmitReglePlate} loading={loading} />
        )}
        {step === 'export' && (
